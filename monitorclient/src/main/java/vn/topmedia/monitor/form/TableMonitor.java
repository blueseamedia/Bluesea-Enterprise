 ...
 */
public class TableMonitor extends javax.swing.JInternalFrame {

    /**
     * Creates new form SMSMonitor
     */
    public TableMonitor(MDIMain mdi) {
        initComponents();
        mdiMain = mdi;
    ...
    private void initComponents() {
        ...
        jTableMessage.getColumnModel().getColumn(0).setMinWidth(50);
        jTableMessage.getColumnModel().getColumn(0).setPreferredWidth(50);
        jTableMessage.getColumnModel().getColumn(0).setMaxWidth(50);
        jTableMessage.getColumnModel().getColumn(1).setMinWidth(50);
        jTableMessage.getColumnModel().getColumn(1).setPreferredWidth(50);
        jTableMessage.getColumnModel().getColumn(1).setMaxWidth(50);
        jTableMessage.getColumnModel().getColumn(2).setMinWidth(100);
        jTableMessage.getColumnModel().getColumn(2).setPreferredWidth(100);
        jTableMessage.getColumnModel().getColumn(2).setMaxWidth(100);
...
//            listModel.clear();
    ...
    private void inits() {
        ...
        jTableMessage.setModel(listModel);
...
//    private void restartMonSocket() {
//        if (server != null) {
//            server.closeSocket();
//            server = null;
//        }
//        try {
//            server = new Server(monUser.getUserPort(), this);
//            server.start();
//        } catch (IOException ioe) {
//            System.out.println("Error restartMonSocket: " + ioe);
//        }
//    }
    ...
    public void alert(MonitorBean bean) {
        ...
        if (node.equals(selectedNode)) {
            if (listModel.getRowCount() > 1000) {
                listModel.removeRow(1000);
            }
            listModel.insertRow(0, new Object[]{bean.getTime(), bean.getType(), bean.getClazz(), bean.getInfo()});
